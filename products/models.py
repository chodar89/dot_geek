...
class Product(models.Model):
    ...
    stock_xs = models.PositiveIntegerField(default=0, verbose_name='Stock Size XS', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    stock_s = models.PositiveIntegerField(default=0, verbose_name='Stock Size S', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    stock_m = models.PositiveIntegerField(default=0, verbose_name='Stock Size M', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    stock_l = models.PositiveIntegerField(default=0, verbose_name='Stock Size L', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    stock_xl = models.PositiveIntegerField(default=0, verbose_name='Stock Size XL', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    stock_xxl = models.PositiveIntegerField(default=0, verbose_name='Stock Size XXL', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    stock_xxxl = models.PositiveIntegerField(default=0, verbose_name='Stock Size XXXL', validators=[MinValueValidator(0), MaxValueValidator(9999)])
    ...
    photo_3 = models.ImageField(upload_to='photos/products/%Y/%m/%d', blank=True)
